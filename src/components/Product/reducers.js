...
export function entryDetails(state={isShowingModal: false}, action) {
  switch(action.type) {
    ...
    case Actions.LOADING_ENTRY_DETAILS: return Object.assign({},state, {dataIsLoaded: true});
    case Actions.LOAD_ENTRY_DETAILS_FAILED: return Object.assign({},state, {dataIsLoaded: false, failure: action.failure, details:undefined});
